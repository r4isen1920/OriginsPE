...
export const enum Items {
    ...
    OriginsMenu = "r4isen1920_originspe:origins_menu",
    OriginsMenuPadding = "r4isen1920_originspe:origins_menu_padding",
    OriginsPowerBurrowSense = "r4isen1920_originspe:origins_power.burrow_sense",
    OriginsPowerHyperLeap = "r4isen1920_originspe:origins_power.hyper_leap",
    OriginsPowerLaunchIntoAir = "r4isen1920_originspe:origins_power.launch_into_air",
    OriginsPowerPhantomize = "r4isen1920_originspe:origins_power.phantomize",
    OriginsPowerPounce = "r4isen1920_originspe:origins_power.pounce",
    OriginsPowerPrescience = "r4isen1920_originspe:origins_power.prescience",
    OriginsPowerShootingStar = "r4isen1920_originspe:origins_power.shooting_star",
    OriginsPowerShulkInventory = "r4isen1920_originspe:origins_power.shulk_inventory",
    OriginsPowerThrowEnderPearl = "r4isen1920_originspe:origins_power.throw_ender_pearl",
    OriginsPowerTunnelLeap = "r4isen1920_originspe:origins_power.tunnel_leap",
    OriginsSubmenu = "r4isen1920_originspe:origins_submenu",
