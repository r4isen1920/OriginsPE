...
function fragmentation(player: Player) {
 ...
 * @param { number } level 
 */
export function changeFragementationLevel(player: Player, level: number) {
...
function onIncrementFragmentationLevel(player: Player, level: number) {
...
function onDecrementFragmentationLevel(player: Player, level: number) {
